          ...
          <Card>
            <BlockStack gap="400">
              ...
              <Text as="p" variant="bodyMd">
                Add a progress bar to your theme that shows customers how close they are to 
                receiving their free gift. This block automatically reads your campaign 
                configuration and displays the current progress.
              </Text>
              ...
              <List type="number">
                ...
                <List.Item>
                  Navigate to the page where you want to add the progress bar (e.g., Cart page)
                </List.Item>
                <List.Item>
                  Click "Add block" and search for "gift-progress-motivators"
                </List.Item>
                <List.Item>
                  Add the "Gift Progress Motivators" block to your desired section
                </List.Item>
                <List.Item>
                  Save your changes
                </List.Item>
              ...
              <List>
                <List.Item>
                  Reads your campaign configuration from the gift_tiers.config metafield
                </List.Item>
                <List.Item>
              ...
              <Box padding="400" background="bg-surface-secondary" borderRadius="200">
                <Text as="p" variant="bodyMd" fontWeight="medium">
                  💡 Pro tip: Place the progress bar on your cart page or product pages 
                  to encourage customers to reach the free gift threshold.
                </Text>
              </Box>
            </BlockStack>
          </Card>
